...
/**
 * HANDBILL CORE - Vanilla JavaScript Implementation
...
(window as any).handleLogin = (role: string) => {
    state.user = {
    ...
    <div class="space-y-8 animate-fade-in">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="h-64 flex items-end justify-between gap-4 px-4 pb-4 border-b border-slate-100">
                    ${[30, 60, 40, 85, 55, 75, 50, 90, 65, 80].map(h => `
                        <div class="w-full bg-slate-100 rounded-t-xl group relative cursor-pointer">
                            ...
                            <div class="absolute -top-8 left-1/2 -translate-x-1/2 bg-slate-900 text-white text-[10px] font-bold px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                                ${h}k
                            </div>
                        </div>
                    `).join('')}
            ...
            <div class="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm">
                ...
                <button onclick="navigate('analytics')" class="w-full mt-10 py-3 text-rose-600 text-[10px] font-black uppercase tracking-widest hover:bg-rose-50 rounded-2xl transition-all">
            ...
            default:
                contentHtml = `
                    <div class="flex flex-col items-center justify-center min-h-[60vh] text-slate-200">
                        ...
                        <p class="font-medium mt-3 text-slate-400">The ${state.currentPage} module is in development.</p>
